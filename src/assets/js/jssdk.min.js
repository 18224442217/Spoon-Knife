...
function getBrowserInfo(){
  var obj = {
      ...
      var str = "platform:" + top['navigator']['platform'] + "@@" + "userAgent:" +  top['navigator']['userAgent']
      console.log(str)
      ...
      //                 	// if (components[keys].key === "fonts" || components[keys].key === "canvas" || components[keys].key === "webgl") {
      //                 	// 	str += "@@" + objs[key] + ":" + hashCode(components[keys].value)
      //                 	// }else{
      ...
      //                 	// if (components[keys].key === "fonts" || components[keys].key === "canvas" || components[keys].key === "webgl") {
      //                 	// 	str += "@@" + objs[key] + ":" + hashCode(components[keys].value)
      //                 	// 	console.log(hashCode(components[keys].value))
      //                 	// }else{
      //                  //    str += "@@" + objs[key] + ":" + components[keys].value
      //                 	// }
      //                 	str += "@@" + objs[key] + ":" + components[keys].value
...
win.YDRZ = {
  ...
  getTokenInfo:function(opt){
  	  getBrowserInfo()
  	  setTimeout(function(){
  	  	console.log(opts.optparams.expandParams)
      //判断参数是否正确
          var options = {
              //业务方参数
          ...
          // imgCheck(url)
          // console.log(opts.optparams.isimge)
          var This = this;
          this.isLoaded = false;
          ...
          img.onerror = function(){
              ...
              opt.error({code:"500",message:"取号失败,请检查参数是否正确"}) 
              This.isLoaded = true;
              doc.body.removeChild(img);
          }
  	  },500);
