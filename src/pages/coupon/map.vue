<template>
  <div class="container">
    ...
    <div id="allmap"
         style="height: 1000px;display: none;"/>
    <div :style="'height:'+sheight+'px'"
      ...
      <baidu-map :zoom="zoom"
        ...
        <bm-geolocation :show-address-bar="true"
                        :auto-location="true"
    ...
    <van-popup v-model="adress"
               :style="{ height: '55%' }"
               round
               position="bottom"
               class="adresss">
      <div class="addressc">
        <div v-for="(item,index) in listAddress"
             :style="c_id==index?'color:#1989fa':''"
             :key="index"
             class="addressl"
      ...
      <div class="blank"/>
      <van-button class="abo"
                  type="info"
                  style="width:21.4375rem;border-radius: 10px"
                  @click="jump">确定
      </van-button>
    </van-popup>
  </div>
