  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="product-container">
        ...
        <div>
          ...
          <div class="order-info">
            <div class="item">
              <div>申请原因<span style="color:red">*</span></div>
              <div class="itemright" @click="showpopup = true">
                  {{ showpopuplist.name }}
                  <img class="boxFixed"
                    src="../../../assets/img/路径备份 3.png"
                    alt="">
                </div>
            </div>
            <div class="item">
      ...
      <van-popup v-model="showpopup" position="bottom" closeable 
        round :style="{ height: '55%' }">
            <div class="popuptitle" >
                退款原因
            </div>
            <div v-for="(popupitem, index) in popuplist"
               :key="index" class="popupitem" @click="changecheck(index)">
               <div class="clearFixed">
                   <div style="float:left">{{popupitem.name}}</div>
                   <img style="float:right" v-if="check == index" 
                    src="../../../assets/img/勾.png"/>
                </div>
            </div>
          <van-button
            class="popupbutton"
...
export default {
  ...
  data() {
    return {
      ...
      showpopup:false,
      popuplist:[
          {index:0,name:'不喜欢、不想要'},
          {index:1,name:'空包裹'},
          {index:2,name:'快递破损'},
          {index:3,name:'其他'}
      ],
      showpopuplist:{index:0,name:'请选择'},
      check:0
    }
  },
  mounted() {
